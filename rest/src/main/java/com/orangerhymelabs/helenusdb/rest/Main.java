...
import com.orangerhymelabs.helenusdb.rest.serialization.SerializationProvider;
...
public class Main
{
	...
	private static void configureMetrics(Configuration config,
	    RestExpress server)
	{
		...
		if (mc.isEnabled())
		{
			...
			if (mc.isGraphiteEnabled())
			{
				...
				final GraphiteReporter reporter = GraphiteReporter
				    .forRegistry(registry).prefixedWith(mc.getPrefix())
	...
	private static void mapExceptions(RestExpress server)
	{
		server
		    ...
		    .mapException(InvalidObjectIdException.class,
